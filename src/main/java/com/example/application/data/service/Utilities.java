...
public class Utilities
{
    ...
    public static boolean sendEmail(String googleUsername, String appPass, String recipientEmail, String subject, String text)
    {
        ...
        Session session = Session.getInstance(properties, new Authenticator()
        {
            ...
            {
                return new PasswordAuthentication(googleUsername, appPass);
            }
        });
        ...
        try
        {
            message.setFrom(new InternetAddress(googleUsername));
            message.setRecipient(Message.RecipientType.TO, InternetAddress.parse(recipientEmail)[0]);
